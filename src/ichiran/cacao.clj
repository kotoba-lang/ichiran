(ns ichiran.cacao
  "Agent-side CACAO issuance (JVM). The ichiran actor mints its OWN
  ...
  `kotoba.cacao` (keep in sync, same copy kekkai.cacao/tayori.cacao/teian.cacao
  carry), and the crypto is JDK Ed25519 + a minimal CBOR encoder.
